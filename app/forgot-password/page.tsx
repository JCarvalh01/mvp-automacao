...
export default function ForgotPasswordPage() {
  ...
  async function handleReset() {
    ...
    try {
      ...
      setMensagem(error?.message || "Erro ao enviar email de recuperação.");
      setTipoMensagem("erro");
    } finally {
      setLoading(false);
    }
      ...
      <div style={containerStyle}>
        ...
        <section style={heroCardStyle}>
          <div>
            ...
            <h2 style={heroTitleStyle}>Recuperação de conta</h2>
            <p style={heroTextStyle}>
              O sistema enviará um link seguro para redefinir sua senha.
            </p>
          </div>

          <div style={heroInfoBoxStyle}>
            <span style={heroInfoLabelStyle}>Etapa</span>
            <strong style={heroInfoValueStyle}>Solicitação de reset</strong>
          </div>
        </section>

        <section style={formCardStyle}>
          <div style={sectionHeaderStyle}>
            <h3 style={sectionTitleStyle}>Digite seu e-mail</h3>
            <p style={sectionTextStyle}>
              Use o e-mail vinculado ao seu acesso no sistema.
            </p>
          </div>
